  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f5f2ec", color: "#0f1629", fontFamily: "system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif", paddingBottom: 84 }}>
      ...
      <nav className="menu">
        ...
        <button className="navbtn" onClick={() => setTab("demo")}>Demo Link</button>
      </nav>
      ...
      <main className="app-shell">
        ...
        <section hidden={tab !== "demo"}>
          <h2 className="title">Refer / Demo</h2>
          <div className="card">
            <p className="muted">This menu section can open a demo version with sample homes, rentals, buildings, businesses, and personal records.</p>
            <div className="row">
            ...
            <div className="card" style={{ marginTop: 14, boxShadow: "none", borderColor: "#e5e7eb" }}>
              ...
              <div className="small muted">Rental homes, duplexes, apartment units, buildings, businesses, subcontractors, and personal records.</div>
            </div>
          </div>
        </section>

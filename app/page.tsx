...
<header id="appHeader">
  ...
  <div class="header-right">
    <span id="modeBadge" class="pill-badge" style="background:#ffcc00;color:#0f1629">LIVE</span>
    <button id="modeToggleBtn" onclick="toggleMode()" class="btn btn-white btn-sm">Demo Mode</button>
...
<nav id="topNav" aria-label="Primary">
  <button class="nav-btn active" data-tab="dashboard" onclick="navigate('dashboard')">Dashboard</button>
  <button class="nav-btn" data-tab="properties" onclick="navigate('properties')">Properties</button>
  <button class="nav-btn" data-tab="rent" onclick="navigate('rent')">Rent Ledger</button>
  <button class="nav-btn" data-tab="expenses" onclick="navigate('expenses')">Expenses</button>
  <button class="nav-btn" data-tab="scanner" onclick="navigate('scanner')">Receipt Scanner</button>
  <button class="nav-btn" data-tab="homeoffice" onclick="navigate('homeoffice')">Home Office</button>
  <button class="nav-btn" data-tab="officiating" onclick="navigate('officiating')">Officiating</button>
  <button class="nav-btn" data-tab="reports" onclick="navigate('reports')">Reports</button>
  <button class="nav-btn" data-tab="ai" onclick="navigate('ai')">AI Assistant</button>
  <button class="nav-btn" data-tab="upgrade" onclick="navigate('upgrade')">Upgrade</button>
  <button class="nav-btn" data-tab="settings" onclick="navigate('settings')">Settings</button>
</nav>
...
/* ---------- Mode / State ---------- */
let mode = localStorage.getItem('taxsavvy_mode') || 'live';
let state = null;
let saveTimer = null;
